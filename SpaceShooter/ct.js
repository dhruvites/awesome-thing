...
ct.rooms.templates['Main'] = {
    ...
    onStep() {
        /* room Main — core_Timer1 (Timer 1 event) */
...
/* room Main — core_Timer2 (Timer 2 event) */
...
ct.templates.copy('EnemyShip', ct.random(ct.camera.width), -100);
    ...
    onDraw() {
        /* room Main — core_OnDraw (On frame end event) */
{
...
ct.templates.templates["PlayerShip"] = {
    ...
    texture: "PlayerShip",
    onStep: function () {
        /* template PlayerShip — core_OnStep (On frame start event) */
{
/**
 * Move the ship
...
/* template PlayerShip — core_OnActionPress (OnActionPress event) */
...
/* template PlayerShip — place_collisionCGroup (Collision with a group event) */
{
...
ct.templates.templates["Laser_Red"] = {
    ...
    texture: "LaserRed",
    onStep: function () {
        /* template Laser_Red — core_OnStep (On frame start event) */
{
...
this.angle -= 4 * ct.delta;
    ...
    onCreate: function () {
        /* template Laser_Red — core_OnCreate (On create event) */
{
this.speed = 8;
this.direction = 90;
...
ct.templates.templates["Laser_Blue"] = {
    ...
    texture: "Laser_Blue",
    onStep: function () {
        /* template Laser_Blue — core_OnStep (On frame start event) */
{
if (this.y < -40) {
    this.kill = true;
}
...
this.move();
    ...
    onCreate: function () {
        /* template Laser_Blue — core_OnCreate (On create event) */
{
this.speed = 18;
this.direction = 270;
}
...
ct.templates.templates["EnemyShip"] = {
    ...
    texture: "EnemyShip",
    onStep: function () {
        /* template EnemyShip — core_OnStep (On frame start event) */
{
this.move();
...
/* template EnemyShip — place_collisionTemplate (Collision with a template event) */
{
...
/* template EnemyShip — core_Timer1 (Timer 1 event) */
...
ct.templates.copy('Laser_Red', this.x, this.y + 32);
    ...
    onCreate: function () {
        /* template EnemyShip — core_OnCreate (On create event) */
{
this.speed = 3;
this.direction = 90;
...
ct.templates.templates["Asteroid_Medium"] = {
    ...
    onStep: function () {
        /* template Asteroid_Medium — core_OnStep (On frame start event) */
{
this.move();
...
/* template Asteroid_Medium — place_collisionTemplate (Collision with a template event) */
{
    const other = ct.place.meet(this, 'Laser_Blue');
    if (ct.templates.valid(other)) {
        other.kill = true;
...
ct.room.score += 10;
    ...
    onCreate: function () {
        /* template Asteroid_Medium — core_OnCreate (On create event) */
{
...
ct.templates.templates["Asteroid_Big"] = {
    ...
    onStep: function () {
        /* template Asteroid_Big — core_OnStep (On frame start event) */
{
this.move();
...
/* template Asteroid_Big — place_collisionTemplate (Collision with a template event) */
{
    const other = ct.place.meet(this, 'Laser_Blue');
    if (ct.templates.valid(other)) {
        other.kill = true;
...
ct.room.score += 25;
    ...
    onCreate: function () {
        /* template Asteroid_Big — core_OnCreate (On create event) */
{
this.speed = ct.random.range(1, 3);
this.direction = ct.random.range(90 - 30, 90 + 30);
}
